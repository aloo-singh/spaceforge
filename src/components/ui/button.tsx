...
function ButtonGroup({
  ...
  return (
    <div
      ...
      className={cn(
        "relative inline-flex items-center overflow-hidden rounded-[min(var(--radius-md),10px)] bg-background shadow-xs before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-border dark:bg-input/30 dark:before:border-input [&>[data-slot=button-group-item]]:relative [&>[data-slot=button-group-item]:hover]:z-10 [&>[data-slot=button-group-item]:focus-within]:z-10 [&>[data-slot=button-group-item]:not(:first-child)]:before:absolute [&>[data-slot=button-group-item]:not(:first-child)]:before:inset-y-0 [&>[data-slot=button-group-item]:not(:first-child)]:before:left-0 [&>[data-slot=button-group-item]:not(:first-child)]:before:w-px [&>[data-slot=button-group-item]:not(:first-child)]:before:bg-border/80 dark:[&>[data-slot=button-group-item]:not(:first-child)]:before:bg-input [&>[data-slot=button-group-item]_[data-slot=button]]:rounded-none [&>[data-slot=button-group-item]_[data-slot=button]]:border-transparent [&>[data-slot=button-group-item]_[data-slot=button]]:bg-transparent [&>[data-slot=button-group-item]_[data-slot=button]]:shadow-none [&>[data-slot=button-group-item]_[data-slot=toggle]]:rounded-none [&>[data-slot=button-group-item]_[data-slot=toggle]]:border-transparent [&>[data-slot=button-group-item]_[data-slot=toggle]]:shadow-none [&>[data-slot=button-group-item]_[data-slot=toggle][aria-pressed=true]]:bg-blue-500 [&>[data-slot=button-group-item]_[data-slot=toggle][aria-pressed=true]]:text-white dark:[&>[data-slot=button-group-item]_[data-slot=toggle][aria-pressed=true]]:bg-blue-500 dark:[&>[data-slot=button-group-item]_[data-slot=toggle][aria-pressed=true]]:text-white",
        className
      )}
      {...props}
    />
