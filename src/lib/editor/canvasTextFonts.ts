...
import { ROOM_LABEL_FONT_SIZE_PX, ROOM_LABEL_FONT_WEIGHT } from "@/lib/editor/roomLabel";
...
export async function preloadEditorCanvasFonts(): Promise<void> {
  ...
  await Promise.allSettled([
    document.fonts.load(buildFontLoadDescriptor(UI_TEXT_FONT_FAMILY, ROOM_LABEL_FONT_SIZE_PX, ROOM_LABEL_FONT_WEIGHT)),
    document.fonts.load(buildFontLoadDescriptor(MEASUREMENT_TEXT_FONT_FAMILY, ROOM_LABEL_FONT_SIZE_PX, ROOM_LABEL_FONT_WEIGHT)),
  ]);
}
