...
import { ChevronRight, IconTriangle, IconTriangleInverted, Plus, Trash2 } from "@/components/ui/icons";
import {
          ...
          {floors.length === 0 ? (
            ...
            <div className="flex flex-col gap-1">
                    ...
                    {isRenaming ? (
                      ...
                      <ContextMenu>
                        ...
                        <ContextMenuContent className="w-48">
                          ...
                          >
                            <IconTriangleInverted className="size-4" />
                            Add floor below
                          </ContextMenuItem>
                        </ContextMenuContent>
                      </ContextMenu>
                    ...
                    {isRoomExpanded ? (
                      <div className={roomDetailsContainerClass}>
                        <div className="mt-1 flex flex-col gap-1">
                          ...
                          {hasInteriorAssets ? (
                            <div className="flex flex-col gap-1">
                              <div className={cn(assetHeaderRowClass, "text-zinc-600 hover:bg-zinc-200/60 hover:text-zinc-900 dark:text-zinc-400 dark:hover:bg-zinc-800/60 dark:hover:text-zinc-100")}>
                                <SidebarIconTooltip
                                  content={
              ...
              <button
                ...
                disabled={isRenameBlocked || !canAddFloor}
                title={!canAddFloor ? `Maximum ${maxFloors} floors reached` : undefined}
              >
