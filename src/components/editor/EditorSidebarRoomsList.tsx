                  ...
                  <div key={floor.id} className="rounded-lg border border-transparent">
                    ...
                    {isFloorExpanded ? (
                      <div className="ml-6 mt-1 flex flex-col gap-1">
                        {floorRooms.length === 0 ? (
                          <div className="rounded-md border border-dashed border-zinc-300/70 bg-zinc-50/50 px-3 py-2 text-xs text-zinc-500 dark:border-border/60 dark:bg-transparent dark:text-muted-foreground">
