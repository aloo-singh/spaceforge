 ...
 */
export type InteriorAssetType = "stairs" | "wardrobe" | "bed" | "sofa" | "dining-table" | "kitchen-unit" | "kitchen-appliance" | "hob" | "sink" | "toilet" | "shower" | "bath" | "basin" | "desk";
...
export type RoomInteriorAsset = {
  ...
  burnerCount?: 2 | 4 | 5 | 6;
  // Sink-specific properties (optional for other assets)
  bowlType?: "single" | "1.5";
