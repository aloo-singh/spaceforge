      ...
      <div className="mx-auto max-w-3xl">
        ...
        <section className="mt-10 rounded-xl border border-border bg-card p-6">
          <div className="flex flex-wrap items-end justify-between gap-3">
            <h2 className="text-2xl font-semibold">v0.82.0</h2>
            <span className="text-sm text-muted-foreground">2026-07-21</span>
          </div>
          ...
          <div className="mt-5 space-y-4 text-sm leading-relaxed text-foreground/90">
            <div>
              ...
              <ul className="mt-2 list-disc space-y-2 pl-5">
                <li>Wall objects foundation: first-class Wall entities with thickness, type (external/internal/user), floor height, and ceiling height.</li>
                <li>Automatic wall generation for newly created rooms.</li>
                <li>One-time migration that adds wall objects to existing rooms.</li>
                <li>Basic wall rendering in the canvas.</li>
                <li>Wall inspector now shows type, thickness, floor height, and ceiling height (region-aware).</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="mt-2 list-disc space-y-2 pl-5">
                <li>Wall rendering is still basic (centred, per-segment). Proper outward offset and continuous/mitered corners are deferred to a follow-up.</li>
                <li>Shared-wall merge/split logic when rooms touch or disconnect is also deferred.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mt-10 rounded-xl border border-border bg-card p-6">
          ...
          <div className="mt-5 space-y-4 text-sm leading-relaxed text-foreground/90">
            <div>
              <h3 className="text-sm font-semibold tracking-wide text-foreground/95">Added</h3>
              <ul className="mt-2 list-disc space-y-2 pl-5">
                <li>Added toilet asset type with cistern and bowl details, responsive stroke styling, full transform feedback, and Sonner notifications for placement, rotation, and deletion.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mt-10 rounded-xl border border-border bg-card p-6">
          <div className="flex flex-wrap items-end justify-between gap-3">
            <h2 className="text-2xl font-semibold">v0.78.9</h2>
            <span className="text-sm text-muted-foreground">2026-05-11</span>
          </div>
          ...
          <div className="mt-5 space-y-4 text-sm leading-relaxed text-foreground/90">
            <div>
              <h3 className="text-sm font-semibold tracking-wide text-foreground/95">Improved</h3>
              <ul className="mt-2 list-disc space-y-2 pl-5">
                <li>Sink rendering: fixed bowl/drainer orientation for all four rotations at rest (180°/270° no longer snapped to the same view as 0°/90°). Added half-bowl rendering for 1.5-bowl sink type. Tightened drainer line padding.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mt-10 rounded-xl border border-border bg-card p-6">
          <div className="flex flex-wrap items-end justify-between gap-3">
            <h2 className="text-2xl font-semibold">v0.78.8</h2>
            <span className="text-sm text-muted-foreground">2026-05-09</span>
          </div>
          ...
          <div className="mt-5 space-y-4 text-sm leading-relaxed text-foreground/90">
            <div>
              <h3 className="text-sm font-semibold tracking-wide text-foreground/95">Added</h3>
              <ul className="mt-2 list-disc space-y-2 pl-5">
                <li>Added sink asset type with configurable bowl types (single/1.5 bowl), optional drainer visualization, full transform feedback, and Sonner notifications for placement and rotation.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mt-10 rounded-xl border border-border bg-card p-6">
          <div className="flex flex-wrap items-end justify-between gap-3">
            <h2 className="text-2xl font-semibold">v0.78.7</h2>
            <span className="text-sm text-muted-foreground">2026-05-09</span>
          </div>
          ...
          <div className="mt-5 space-y-4 text-sm leading-relaxed text-foreground/90">
            <div>
              <h3 className="text-sm font-semibold tracking-wide text-foreground/95">Added</h3>
              <ul className="mt-2 list-disc space-y-2 pl-5">
                <li>Added hob/cooktop asset type with configurable burner count (2/4/5/6 burners), adaptive burner visualization, full transform feedback, and Sonner notifications for placement and rotation.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mt-10 rounded-xl border border-border bg-card p-6">
          <div className="flex flex-wrap items-end justify-between gap-3">
            <h2 className="text-2xl font-semibold">v0.78.6</h2>
          ...
          <div className="mt-5 space-y-4 text-sm leading-relaxed text-foreground/90">
            <div>
              <h3 className="text-sm font-semibold tracking-wide text-foreground/95">Added</h3>
              <ul className="mt-2 list-disc space-y-2 pl-5">
                <li>Added kitchen appliance asset type with dashed diagonal corner lines for microwave-style visual distinction, full transform feedback, and Sonner undo/redo support.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mt-10 rounded-xl border border-border bg-card p-6">
          <div className="flex flex-wrap items-end justify-between gap-3">
            <h2 className="text-2xl font-semibold">v0.78.5</h2>
            <span className="text-sm text-muted-foreground">2026-05-08</span>
          </div>
          ...
          <div className="mt-5 space-y-4 text-sm leading-relaxed text-foreground/90">
            <div>
              <h3 className="text-sm font-semibold tracking-wide text-foreground/95">Added</h3>
              <ul className="mt-2 list-disc space-y-2 pl-5">
                <li>Added kitchen unit asset type with full support for resizing, rotating, and undo/redo with Sonner notifications.</li>
              </ul>
            </div>
            ...
            <div>
              <h3 className="text-sm font-semibold tracking-wide text-foreground/95">Fixed</h3>
              <ul className="mt-2 list-disc space-y-2 pl-5">
                <li>Fixed rotation direction labels in undo history so both left and right rotations display correctly.</li>
                <li>Fixed browser persistence so kitchen unit assets now survive page refreshes.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mt-10 rounded-xl border border-border bg-card p-6">
          <div className="flex flex-wrap items-end justify-between gap-3">
            <h2 className="text-2xl font-semibold">v0.78.4</h2>
            <span className="text-sm text-muted-foreground">2026-05-08</span>
          </div>
          ...
          <div className="mt-5 space-y-4 text-sm leading-relaxed text-foreground/90">
            <div>
              <h3 className="text-sm font-semibold tracking-wide text-foreground/95">Fixed</h3>
              <ul className="mt-2 list-disc space-y-2 pl-5">
                <li>Fixed list-view project info chips so the created date no longer truncates to the day number when paid-tier project stats are visible.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mt-10 rounded-xl border border-border bg-card p-6">
          ...
          <div className="mt-5 space-y-4 text-sm leading-relaxed text-foreground/90">
            <div>
              <h3 className="text-sm font-semibold tracking-wide text-foreground/95">Added</h3>
              <ul className="mt-2 list-disc space-y-2 pl-5">
                <li>Completed the <code className="bg-muted px-1.5 py-0.5 rounded text-xs">/projects</code> improvement trio with persisted layout toggles for small grid, large grid, and list browsing.</li>
              </ul>
            </div>
            ...
            <div>
              <h3 className="text-sm font-semibold tracking-wide text-foreground/95">Improved</h3>
              <ul className="mt-2 list-disc space-y-2 pl-5">
                <li>Polished project cards so filtering, the hybrid info overlay, and the selected layout mode work together across desktop and mobile.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mt-10 rounded-xl border border-border bg-card p-6">
          ...
          <div className="mt-5 space-y-4 text-sm leading-relaxed text-foreground/90">
            ...
            <div>
              <h3 className="text-sm font-semibold tracking-wide text-foreground/95">Improved</h3>
              <ul className="mt-2 list-disc space-y-2 pl-5">
                <li>Info overlay spacing was tuned for the current thumbnail aspect ratio in both two-metric Free and four-metric paid layouts.</li>
                <li>The toggle animation now uses a gentle thumbnail blur/scale and overlay fade, while respecting reduced-motion preferences.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mt-10 rounded-xl border border-border bg-card p-6">
          ...
          <div className="mt-5 space-y-4 text-sm leading-relaxed text-foreground/90">
            <div>
              <h3 className="text-sm font-semibold tracking-wide text-foreground/95">Fixed</h3>
              <ul className="mt-2 list-disc space-y-2 pl-5">
                <li>New project button no longer resizes or flashes weirdly when clicked</li>
                <li>Empty projects no longer saved to /projects—only persisted after first room is drawn</li>
                <li>Homepage no longer forces redirect when navigating via nav bar link (link now preserves navigation intent)</li>
                ...
                <li>Clicking a room on another floor in sidebar now selects the room and switches to that floor</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="mt-2 list-disc space-y-2 pl-5">
                ...
                <li>Linked staircase rooms on both floors now get a helpful outline for visual connection</li>
                <li>Added stair count display in stairs inspector showing number of treads (300mm sections)</li>
              </ul>
            </div>
          </div>
        </section>
